...
rm(list=ls())
#Load the data set 
#heart_disease <-read.csv("/Users/ishani/Documents/Math  449/heart_2020_cleaned.csv", stringAsFactors = TRUE)
...
### Setting reference variables, ordering factors with multiple levels
...
DiabeticScore = c(0, 1, 2, 3) # (No, No borderline, Yes, Yes pregnant) (ref=No)
...
# Adding scores to ordinal variables
