...
hist(heart_disease$PhysicalHealth)
hist(heart_disease$MentalHealth)
...
library(Epi)
# ROC curve and AUC
hd.roc = ROC(form=HeartDisease ~ . -PhysicalActivity, data=test.df, plot="ROC", MX = TRUE)
```
